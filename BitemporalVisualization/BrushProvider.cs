...
namespace BitemporalVisualization
{
    public class BrushProvider
    {
        ...
        private Dictionary<long, Gradient> gradientMappings;
        private long highlightedTransaction;

        public BrushProvider(long tId)
        {
            highlightedTransaction = tId;
            gradients = new List<Gradient>();
            gradientMappings = new Dictionary<long, Gradient>();
